 ...
 * decides nothing. Pressing the answer types it at the agent — the number the
...
export function AskNode({ data }: NodeProps<AskFlowNode>) {
  ...
  return (
    <div className="ask">
      ...
      {/* The answers, in the agent's own order and with the agent's own
          numbers. The one it is standing on is marked rather than made to look
          like the one to press: which answer the agent has under its cursor is
