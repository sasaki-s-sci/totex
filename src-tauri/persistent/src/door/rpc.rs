...
pub fn answer(door: &Door, session: &str, body: &[u8]) -> Option<Value> {
    ...
    Some(match method {
        ...
        "tools/call" => said(id, call(door, session, &params)),
...
/// One call of it.
fn call(door: &Door, session: &str, params: &Value) -> Value {
    ...
    super::report::keep(door, session, report);
