...
//!
//! Which host a path is on and how to reach it — this machine, a WSL
//! distribution reached from Windows, or a machine reached over ssh — and
//! everything the app asks of a folder through that: listing it, reading a
